...
def _set_required_env(monkeypatch, *, recipient_emails="parent@example.com"):
    ...
    monkeypatch.setenv("MATHACADEMY_STUDENT_IDS", "student-1")
...
def test_blank_only_recipient_email_list_fails_before_browser_launch(monkeypatch):
    ...
    def fail_setup_driver():
        pytest.fail("setup_driver should not be called for invalid RECIPIENT_EMAILS")
